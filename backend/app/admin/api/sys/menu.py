...
@router.get('/info', summary='获取菜单信息', response_model=ResponseSchemaModel[SysMenuInfo])
...
@router.get('/detail', summary='获取菜单详情', response_model=ResponseSchemaModel[SysMenuDetail])
...
@router.get('/list', summary='获取菜单列表', response_model=ResponseSchemaModel[list[SysMenuListItem]])
...
@router.get('/list-tree', summary='获取菜单树形表格', response_model=ResponseSchemaModel[list[SysMenuTableTree]])
...
@router.get('/tree', summary='获取菜单树', response_model=ResponseSchemaModel[list[SysMenuTreeNode]])
...
@router.get('/options', summary='获取菜单选项', response_model=ResponseSchemaModel[list[SysMenuOption]])
...
@router.get('/option-tree', summary='获取菜单选项树', response_model=ResponseSchemaModel[list[SysMenuOptionTree]])
...
@router.get('/routes', summary='获取前端路由配置', response_model=ResponseSchemaModel[list[SysMenuRoute]])
...
@router.put('/update', summary='更新菜单信息')
...
@router.patch('/update/status', summary='更新菜单状态')
...
@router.patch('/update/hidden', summary='更新菜单隐藏状态')
...
@router.patch('/update/sort', summary='更新菜单排序')
...
@router.patch('/update/parent', summary='更新菜单父级')
...
@router.patch('/batch/update/status', summary='批量更新菜单状态')
...
@router.delete('/batch/delete', summary='批量删除菜单')
